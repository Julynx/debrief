...
- [x] Remove print statements entirely and replace them with logging calls of the appropriate severity.
- [x] Remove all inline comments. Add/update high quality module, class and function/method docstrings to the project.
- [x] Parse and display description from pyproject.toml
- [x] Parse dependencies from pyproject.toml, falling back to requirements.txt if not present.
